...
| **BPTopTracker 500 redirect to Beatport** | Redirects BPTopTracker HTTP 500/Internal Server Error pages to the equivalent Beatport URL. | Not tested! ⚠️ | [![Install](https://img.shields.io/badge/Install-.user.js-2ea44f?style=for-the-badge)](https://raw.githubusercontent.com/karpuzikov/userscripts/main/browser-tools/bptoptracker-to-beatport/BPTopTracker_to_Beatport.user.js) |
...
| **Apple Music Composition & Lyrics -> MusicBrainz** | Imports Apple Music Composition & Lyrics credits into the linked MusicBrainz Work relationships for release tracks, with artist matching and review before applying. | 1.0.0 (not tested) | [![Install](https://img.shields.io/badge/Install-.user.js-2ea44f?style=for-the-badge)](https://raw.githubusercontent.com/karpuzikov/userscripts/main/musicbrainz-tools/apple-music-composition-lyrics-importer/MusicBrainz_Apple_Music_Composition_Lyrics_Importer.user.js) |
| **MusicBrainz Barcode vs Linked Releases Checker** | Checks Digital Media release barcodes against linked provider release pages through Harmony, finds provider links by barcode when missing/unreadable, and opens reviewable correcting edits without auto-submitting them. | Not tested! ⚠️ | [![Install](https://img.shields.io/badge/Install-.user.js-2ea44f?style=for-the-badge)](https://raw.githubusercontent.com/karpuzikov/userscripts/main/musicbrainz-tools/barcode-linked-release-checker/MusicBrainz_Barcode_Linked_Release_Checker.user.js) |
...
| **Harmony - Link External IDs in One Click** | Fast Harmony -> MusicBrainz external-ID submission. The global all-in-one button is placed directly above the first available external-ID section; Artists, Labels, and Songs get their own buttons inside their respective Harmony sections, and type-specific buttons appear only when that type actually has links to submit. | Not tested! ⚠️ | [![Install](https://img.shields.io/badge/Install-.user.js-2ea44f?style=for-the-badge)](https://raw.githubusercontent.com/karpuzikov/userscripts/main/musicbrainz-tools/harmony-link-external-ids-one-click/Harmony_Link_External_IDs_in_One_Click.user.js) |
