...
| **Apple Music Credits -> MusicBrainz** | Verifies the Apple Music release, routes credits to Recording/Work/Release, resolves or creates missing Works, and uses a shared throttled MusicBrainz Web Service queue with caching and automatic retries for 429/502/503/504 responses. | 2.1.2 (not tested ⚠️) | [![Install](https://img.shields.io/badge/Install-.user.js-2ea44f?style=for-the-badge)](https://raw.githubusercontent.com/karpuzikov/userscripts/main/musicbrainz-tools/apple-music-composition-lyrics-importer/MusicBrainz_Apple_Music_Composition_Lyrics_Importer.user.js?v=2.1.2) |
