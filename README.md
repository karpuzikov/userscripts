...
| **Harmony - Link External IDs in One Click** | Adds four Harmony controls: one all-in-one button plus separate buttons for artists, labels, and songs. Uses one MusicBrainz background bridge tab to fetch and POST the seeded edit forms directly, with up to four concurrent submissions instead of navigating one edit tab at a time. | Not tested! ⚠️ | [![Install](https://img.shields.io/badge/Install-.user.js-2ea44f?style=for-the-badge)](https://raw.githubusercontent.com/karpuzikov/userscripts/main/musicbrainz-tools/harmony-link-external-ids-one-click/Harmony_Link_External_IDs_in_One_Click.user.js) |
