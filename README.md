...
| **Apple Music Credits -> MusicBrainz** | Verifies the Apple Music release, reads all available track credit sections, routes credits to Recording/Work/Release, searches for an exact MusicBrainz Work when songwriting credits need one, links it when uniquely found, and stages a new Work when no exact match exists. | 2.1.0 (not tested ⚠️) | [![Install](https://img.shields.io/badge/Install-.user.js-2ea44f?style=for-the-badge)](https://raw.githubusercontent.com/karpuzikov/userscripts/main/musicbrainz-tools/apple-music-composition-lyrics-importer/MusicBrainz_Apple_Music_Composition_Lyrics_Importer.user.js) |
