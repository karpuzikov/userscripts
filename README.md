...
| **Apple Music Credits -> MusicBrainz** | Verifies the Apple Music release, routes credits to Recording/Work/Release, resolves artists through four priority context circles, resolves or creates missing Works, and when a new Work is needed opens MusicBrainz's native Work dialog with Work type Song preselected so the user can choose the lyrics language before staging it. | 2.3.3 (not tested ⚠️) | [![Install](https://img.shields.io/badge/Install-.user.js-2ea44f?style=for-the-badge)](https://raw.githubusercontent.com/karpuzikov/userscripts/tampermonkey-apple-music-credits-v2.3.3/musicbrainz-tools/apple-music-composition-lyrics-importer/MusicBrainz_Apple_Music_Composition_Lyrics_Importer.user.js) |
