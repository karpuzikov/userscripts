...
| **Apple Music Composition & Lyrics -> MusicBrainz** | Automatically verifies existing Apple Music/iTunes links against the MusicBrainz barcode, falls back to Apple Music UPC search when needed, then imports Composition & Lyrics credits into Work relationships. | 1.1.0 (not tested ⚠️) | [![Install](https://img.shields.io/badge/Install-.user.js-2ea44f?style=for-the-badge)](https://raw.githubusercontent.com/karpuzikov/userscripts/main/musicbrainz-tools/apple-music-composition-lyrics-importer/MusicBrainz_Apple_Music_Composition_Lyrics_Importer.user.js) |
