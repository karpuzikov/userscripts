...
In Picard 3.0 use `Options -> Plugins -> Install Plugin -> Install from URL`:

- Git URL: `https://github.com/karpuzikov/userscripts`
- Ref/Tag: use the branch shown in that plugin's README.
