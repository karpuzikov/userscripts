...
| **Apple Music Credits -> MusicBrainz** | Verifies the Apple Music release, reads all available track credit sections, and routes supported roles to the proper MusicBrainz entity: production/performance to Recordings, songwriting/composition to Works, and mastering to the Release. | 2.0.0 (not tested ⚠️) | [![Install](https://img.shields.io/badge/Install-.user.js-2ea44f?style=for-the-badge)](https://raw.githubusercontent.com/karpuzikov/userscripts/main/musicbrainz-tools/apple-music-composition-lyrics-importer/MusicBrainz_Apple_Music_Composition_Lyrics_Importer.user.js) |
