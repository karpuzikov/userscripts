...
| **RuTracker Digital Release Linker** | Finds and inserts exact digital-store release pages in RuTracker edit BBCode. Deezer support uses barcodes directly, retries equivalent UPC/EAN forms and MusicBrainz-verified regional barcodes, resolves catalog numbers through MusicBrainz, and can replace an existing generic Deezer artist link with the release page. Entries without an identifier or artist link are left untouched. | 1.0.2 | [![Install](https://img.shields.io/badge/Install-.user.js-2ea44f?style=for-the-badge)](https://raw.githubusercontent.com/karpuzikov/userscripts/main/browser-tools/rutracker-digital-release-linker/RuTracker_Digital_Release_Linker.user.js) |
