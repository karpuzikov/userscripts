...
| Project | Description | Version | Download |
| --- | --- | ---: | --- |
| **MusicBrainz - Safe Recording Matcher** | Checks exact track title and full artist credit, requires a unique recording within 7 seconds using exact millisecond lengths, and leaves uncertain tracks for manual review. | 1.0.0 (not live tested) | [![Install](https://img.shields.io/badge/Install-.user.js-2ea44f?style=for-the-badge)](https://raw.githubusercontent.com/karpuzikov/userscripts/main/musicbrainz-tools/safe-recording-matcher/MusicBrainz_Safe_Recording_Matcher.user.js) |
